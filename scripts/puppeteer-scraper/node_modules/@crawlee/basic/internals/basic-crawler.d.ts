...
import type { AddRequestsBatchedOptions, AddRequestsBatchedResult, AutoscaledPoolOptions, CrawlingContext, EnqueueLinksOptions, EventManager, DatasetExportOptions, FinalStatistics, GetUserDataFromRequest, IRequestList, ProxyInfo, Request, RequestOptions, RouterHandler, RouterRoutes, Session, SessionPoolOptions, Source, StatisticState, StatisticsOptions, LoadedContext } from '@crawlee/core';
...
export type RequestHandler<Context extends CrawlingContext = BasicCrawlingContext> = (inputs: LoadedContext<Context>) => Awaitable<void>;
export type ErrorHandler<Context extends CrawlingContext = BasicCrawlingContext> = (inputs: LoadedContext<Context>, error: Error) => Awaitable<void>;
